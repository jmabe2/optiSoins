		...
		if (UtilisateurService.checkRole(user, Arrays.asList("Admin"))) {
			...
			if (action.equalsIgnoreCase("edit")) {
				...
				try {
					...
					Equipement equip = service.updateEquipement(Integer.parseInt(request.getParameter("equipementId")),
				...
				try {
					...
					Equipement equip = service.createEquipement(request.getParameter("name"),
