	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (UtilisateurService.checkRole(user, Arrays.asList("Admin", "Médecin", "Infirmière"))) {
			...
			if (action.equalsIgnoreCase("view")) {
				...
				request.setAttribute("patients", service.searchPatients(request.getParameter("searchnom"),
						request.getParameter("searchprenom")));
				// case Edit
				...
				if (erreurs.isEmpty()) {
					...
					try {
						...
						Patient patient = service.updatePatient(Integer.parseInt(request.getParameter("patientId")),
				...
				if (erreurs.isEmpty()) {
					...
					try {
						...
						em.getTransaction().begin();
						Patient patient = service.createPatient((request.getParameter("actif") != null),
								request.getParameter("nom"), request.getParameter("prenom"),
								request.getParameter("sexe"), sdf.parse(request.getParameter("datenaiss")),
