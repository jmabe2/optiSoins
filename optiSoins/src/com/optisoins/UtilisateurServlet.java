				...
				if (erreurs.isEmpty()) {
					...
					try {
						...
						Utilisateur utilisateur = service.updateUtilisateur(
								...
								(request.getParameter("specialite") != null ? specialiteService
										.findSpecialite(Integer.parseInt(request.getParameter("specialite"))) : null));
				...
				if (erreurs.isEmpty()) {
					...
					try {
						...
						Utilisateur utilisateur = service.createUtilisateur((request.getParameter("actif") != null),
								...
								request.getParameter("login"), request.getParameter("mdp"),
								roleService.findRole(Integer.parseInt(request.getParameter("role"))),
								(request.getParameter("specialite") != null ? specialiteService
										.findSpecialite(Integer.parseInt(request.getParameter("specialite"))) : null));
