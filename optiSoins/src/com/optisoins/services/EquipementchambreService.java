...
public class EquipementchambreService {
	...
	public List<Equipementchambre> findAllEquipementchambre() {
		...
		TypedQuery<Equipementchambre> query = em.createQuery("SELECT s from Equipementchambre s",
				Equipementchambre.class);
	...
	public List<Equipementchambre> findAllEquipementchambre(int chambreId) {
		TypedQuery<Equipementchambre> query = em
				.createQuery("SELECT s from Equipementchambre s where s.chambre.idChambre=:chambreId",
						Equipementchambre.class)
