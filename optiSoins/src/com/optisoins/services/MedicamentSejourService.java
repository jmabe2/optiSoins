...
public class MedicamentSejourService {
	 ...
	 * @return
	 */
	public Medicamentsejour createMedicamentsejour(boolean actif, int medicamentId, String indication, String posologie,
			String remarque, int sejourId) {
	...
	public Medicamentsejour updateMedicamentsejour(int idMedicamentsejour, boolean actif, int medicamentId,
			String indication, String posologie, String remarque, int sejourId) {
	...
	public List<Medicamentsejour> findAllMedicamentsejour() {
		...
		TypedQuery<Medicamentsejour> query = em.createQuery("SELECT ms from Medicamentsejour ms",
				Medicamentsejour.class);
